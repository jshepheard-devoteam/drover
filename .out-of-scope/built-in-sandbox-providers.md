...
Drover does not grow the set of **built-in** sandbox providers on request. The shipped list (Docker, Podman, Vercel, Daytona, and the no-op `noSandbox`) is deliberately curated.
