---
title: Configuration
description: Configure Drover for your project.
---

## Config Directory

The `.drover/` directory in your repository contains all Drover configuration:
...
The `config.json` file controls how Drover operates:
...
Drover resolves environment variables from multiple sources in order:
